...
void print_and_save(Query &q, TextQuery &tq, vector<Query> &q_vec){
...
//	runQueries(i_file);
	...
	print_and_save(q, tq, q_vec);
	auto q1 = Query("her");
	cout << q_vec.size() << endl;
	auto q2 = q_vec[0] & Query("her");
	print_and_save(q2, tq, q_vec);
