...
struct DebugDelete{
	...
	template<typename T> DebugDelete(T *p, ostream &os = cout){
...
inline Query operator~(const Query &operand){return shared_ptr<Query_base>(new NotQuery(operand), [](Query_base *val){DebugDelete ex(val);});}
...
inline Query operator&(const Query& lhs, const Query& rhs){return shared_ptr<Query_base>(new AndQuery(lhs, rhs), [](Query_base *val){DebugDelete ex(val);});}
...
inline Query operator|(const Query& lhs, const Query& rhs){return shared_ptr<Query_base>(new OrQuery(lhs, rhs), [](Query_base *val){DebugDelete ex(val);});}
